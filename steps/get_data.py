...
from syntheas_mltools_mgmt.zenml.data import get_df_test_onehot, get_df_train_onehot, get_df_val_onehot, get_df_synthtrain_tabsyn_onehot2
...
def get_tabsyn_data_step() -> Tuple[
    ...
    df_train = get_df_synthtrain_tabsyn_onehot2()
    try:
        df_train.drop(columns=['id', 'combined_tks'], inplace=True)
    except Exception as e:
        print(f"Error dropping columns in train data: {e}")
